    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
				...
				<span class="username">{{ $user->name }} ({{ $user->role->name ?? 'No Role' }})</span>
                <b class="caret"></b>
            </a>
    ...
    <div class="leftside-navigation">
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
					<li><a href="{{ route('admin.products.index') }}"><i class="fa fa-cube"></i> Product Management</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2025 Visitors. All rights reserved | Design by <a href="http://w3layouts.com">L-Fashionify</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
